...
// Using the GitHub icon from lucide-react as mentioned in the implementation guidelines
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 pt-8 md:pt-16 text-center lg:gap-12">
          ...
          >
            <Button
              ...
              size="lg"
              className={cn(
                "bg-gradient-to-b from-trading-blue to-trading-blue/90 dark:from-trading-blue/90 dark:to-trading-blue/80",
                "hover:from-trading-blue/95 hover:to-trading-blue/85 dark:hover:from-trading-blue/80 dark:hover:to-trading-blue/70",
          ...
          <div className="relative w-full pt-12 px-4 sm:px-6 lg:px-8">
            <Mockup
              className={cn(
                ...
                "border-trading-blue/10 dark:border-trading-blue/5",
              )}
            >
              <img
                {...mockupImage}
