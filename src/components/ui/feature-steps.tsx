...
export function FeatureSteps({
  ...
  return <div className={cn("p-8 md:p-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-3xl md:text-4xl mb-10 text-center font-extralight lg:text-5xl">
          {title}
        </h2>
          ...
          <div className="order-2 md:order-1 space-y-8">
            ...
            duration: 0.5
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-extralight md:text-3xl">
                    {feature.title || feature.step}
                  </h3>
                  <p className="text-sm text-slate-950 font-extralight md:text-2xl">
                    {feature.content}
                  </p>
                </div>
              </motion.div>)}
