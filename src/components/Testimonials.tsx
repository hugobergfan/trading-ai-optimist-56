  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">Trusted by Traders</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <TestimonialCard 
            quote="Finox AI has completely transformed my trading strategy. The automation has saved me countless hours."
            author="Michael R."
            role="Investment Analyst"
          />
          
          <TestimonialCard 
            quote="As someone new to trading, Finox AI made it possible for me to participate in markets I didn't understand."
            author="Sarah T."
            role="Tech Entrepreneur"
          />
          
          <TestimonialCard 
            quote="The risk management features give me peace of mind. My portfolio has grown steadily without the stress."
            author="David L."
