...
const data = [
  { name: 'Jan', ai: 400, market: 240 },
  { name: 'Feb', ai: 430, market: 250 },
  { name: 'Mar', ai: 450, market: 260 },
  { name: 'Apr', ai: 470, market: 280 },
  { name: 'May', ai: 540, market: 290 },
  { name: 'Jun', ai: 580, market: 300 },
  { name: 'Jul', ai: 650, market: 310 },
  { name: 'Aug', ai: 700, market: 340 },
  { name: 'Sep', ai: 750, market: 350 },
  { name: 'Oct', ai: 790, market: 360 },
  { name: 'Nov', ai: 820, market: 370 },
  { name: 'Dec', ai: 900, market: 390 },
];
...
const PerformanceComparison = () => {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
      <div className="container mx-auto">
        ...
        <div className="mt-12 rounded-xl shadow-sm border p-4 bg-white animate-fade-in" style={{ animationDelay: '0.8s' }}>
