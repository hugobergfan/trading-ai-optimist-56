      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>Do I need trading experience to use Finox AI?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>What are the fees associated with Finox AI?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger>Can I stop the bot at any time?</AccordionTrigger>
            <AccordionContent>
