...
export function HeroDemo() {
  ...
  return <section className="relative overflow-hidden py-20 md:py-32 px-5">
      <div className="relative z-10 container max-w-screen-xl mx-auto text-center">
        <TextShimmer as="h1" className="text-4xl md:text-7xl font-extralight tracking-wider mb-6 [--base-color:theme(colors.blue.700)] [--base-gradient-color:theme(colors.blue.400)]">
